...
| 9 | ✅ 코드 완료 | `1.8.0` | [PHASE-09](docs/phases/PHASE-09.md) | [리포트](docs/reports/phase-09-test-report.md) |
...
- **주거 로드맵** (도메인·DataStore) — 매각·이주 연결; **대시보드 UI는 Phase 9에서 타이밍 컨설팅으로 대체**

- **2주택·무주택 구간** — 월표·엔진 flags

- **A/B 차트** — 현재 vs 시나리오 비교 (Phase 9: 제안 매각 시점)
...
- **대시보드 그룹** — 6개 상위 그룹 접기/펼치기, 접힌 상태 요약

- **자산운용 총평** — 점수·등급·잘된 점/부족한 점/유의할 점

- **월표** — 은퇴·매각 등 이벤트 기반 전환 시점 요약, 은퇴 후 연도별 펼침

- **PDF 자산운용 리포트** — 총평·전환 시점·연표·부동산 타이밍 컨설팅

- **부동산 타이밍 컨설팅** — 취득·매각 연도, 타임라인 드래그, 제안 적용·A/B

- **거래 세금** — 취득세·중개보수·양도세·일시적 1가구2주택(간이); 보유세는 매년 반영
...
- JUnit 단위 테스트 (**136건**) · Compose UI 테스트
