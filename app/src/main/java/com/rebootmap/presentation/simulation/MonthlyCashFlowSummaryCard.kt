...
fun MonthlyCashFlowSummaryCard(
    ...
    Card(
        ...
        Column(
            ...
            Text(
                text = "월 수입은 세전, 월 순현금은 생활비·보유세·세금 차감 후. 월 세금 탭 시 세목별 표시",
            ...
            Text(
                text = "월 순현금이 흑자(+)여도 총자산이 줄 수 있습니다. " +
                    "퇴직·개인연금 등에서 인출한 금액은 수입으로 잡히지만, " +
                    "그중 생활비·세금으로 쓰인 부분만큼 적립 잔액이 줄어 총자산(아래 차트)이 감소합니다.",
                style = MaterialTheme.typography.bodySmall,
                color = MaterialTheme.colorScheme.onSurfaceVariant,
            )
        }
